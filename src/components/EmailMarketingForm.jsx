            ...
            case 8:
                return (
                    <div>
                        ...
                        />
                        <p className="text-xs text-gray-500 mt-2">By entering your email above, you consent to receive marketing emails from Compare-Bazaar.<a href="TermsOfUse" className="text-[#ff8633] hover:underline">Terms and Conditions</a> and <a href="/PrivacyPolicy" className="text-[#ff8633] hover:underline">Privacy Policy</a> which are also linked at the bottom of this page.</p>
                    </div>
                );
